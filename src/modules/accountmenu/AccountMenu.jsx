            ...
            propertyBusiness: [
                {
                    ...
                    doors: 'Закрыты',
                    img: 'https://gta-5.ru/server/client/images/mmenu/stock.jpg'
                },
                {
                    type: 2,
                    title: 'Бизнес',
                    ...
                    doors: 'Открыты',
                    img: 'https://gta-5.ru/server/client/images/mmenu/office.jpg'
                },
                {
                    type: 0,
                    title: 'Квартира',
                    ...
                    address: 'Саут-Рокфорд-драйв,  д. 0112, кв.14',
                    doors: 'Открыты',
                    img: 'https://gta-5.ru/server/client/images/mmenu/condo.jpg'
                },
                {
                    type: 0,
                    title: 'Апартаменты',
                ...
                },
                {
                    ...
                    address: 'Саут-Рокфорд-драйв,  д. 0112, кв.14',
                    doors: 'Открыты',
                    img: 'https://gta-5.ru/server/client/images/mmenu/yacht.jpg'
                }
            ],
            propertyCars: [
                {
            ...
            questData: [
                {
                    title: 'Фруктовый вор', subtitle: '3 задания', done: true, tasks: [
                        {title: 'Кража апельсинов', text: 'Украсть 2 кг апельсин Украсть 2 кг апельсин Украсть 2 кг апельсин Украсть 2 кг апельсин Украсть 2 кг апельсин Украсть 2 кг апельсин Украсть 2 кг апельсин', reward: '$ 5 000', complete: 0},
                ...
                {
                    title: 'Механик', subtitle: '1 задание', done: true, tasks: [
            ...
            settingsData: [
                {
                    ...
                    desc: 'test',
                    settings: [
                        {type: 0, name: 'Показывать худ', params: 'reload1', active: 1},
                ...
                },
                {
                    ...
                    type: 'key_bind',
                    settings: [
                        {type: 3, name: 'Голосовой чат', params: 'reload', btntext: "И"},
                        {type: 3, name: 'Голосовой чат', params: 'reload', btntext: "И"},
                        {type: 3, name: 'Голосовой чат', params: 'reload', btntext: "И"},
                        {type: 3, name: 'Голосовой чат', params: 'reload', btntext: "И"},
                        {type: 3, name: 'Голосовой чат', params: 'reload', btntext: "И"},
