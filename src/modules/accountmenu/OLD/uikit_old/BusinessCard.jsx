        ...
        <div className="accountmenu__content__cards__business">
            <div className="accountmenu__content__cards__business__img__container" style={{backgroundImage: `url(${img})`}}>
                <div className={
                    ...
                    <img 
                        src={
                            type === 0 ? `https://gta-5.ru/server/client/images/icons/components/accountmenu/img/property__house__icon.svg` :
                            (type === 1 ? `https://gta-5.ru/server/client/images/icons/components/accountmenu/img/property__case__icon.svg` : `https://gta-5.ru/server/client/images/icons/components/accountmenu/img/property__apart__icon.svg`)
                        }
                        alt=""
