...
export default class Map extends React.Component {
    ...
    clickBtn = (e) => {
        try {
            mp.trigger('clickBtnMapSetting', this.state.item[e.target.id].data) // eslint-disable-line
        } catch (error) {
            console.log('clickBtnMapSetting', this.state.item[e.target.id].data)
        }
    }
    clickSelect = (e) => {
        let state = []
        ...
        try {
            mp.trigger('editMapSettings', this.state.item) // eslint-disable-line
        } catch (error) {
            console.log('editMapSettings', this.state.item)
        }
    }
    clickCheckbox = (e) => {
        let el = e.target
