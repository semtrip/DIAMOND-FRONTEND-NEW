...
export default class Main extends React.Component {
    ...
    clickBtn = (e) => {
        try {
            mp.trigger('clickBtnMainSetting', this.state.item[e.target.id].data) // eslint-disable-line
        } catch (error) {
            console.log('clickBtnMainSetting', this.state.item[e.target.id].data)
        }
    }
    clickSelect = (e) => {
        let state = []
        ...
        try {
            mp.trigger('editMainSettings', this.state.item) // eslint-disable-line
        } catch (error) {
            console.log('editMainSettings', this.state.item)
        }
    }
    clickCheckbox = (e) => {
        let el = e.target
