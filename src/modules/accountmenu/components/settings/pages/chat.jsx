...
export default class Chat extends React.Component {
    ...
    clickBtn = (e) => {
        try {
            mp.trigger('clickBtnChatSetting', this.state.item[e.target.id].data) // eslint-disable-line
        } catch (error) {
            console.log('clickBtnChatSetting', this.state.item[e.target.id].data)
        }
    }
    clickSelect = (e) => {
        let state = []
        ...
        try {
            mp.trigger('editChatSettings', this.state.item) // eslint-disable-line
        } catch (error) {
            console.log('editChatSettings', this.state.item)
        }
    }
    clickCheckbox = (e) => {
        let el = e.target
