...
const Settings = ({ data, activeData }) => {
    ...
    return (
        <React.Fragment>
            <div className="accountmenu__content__cards__header__item">
                <div className="accountmenu__content__cards__settings__list settings__scrollable">
            ...
            <div className="accountmenu__content__cards__blitem accountmenu__scrollable">
                <div className={`accountmenu__content__cards__settings__container ${settings[active].type === 'key_bind' ? 'bind_keys': ''}`}>
