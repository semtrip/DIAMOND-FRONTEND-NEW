...
class Android extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            rotate: false,
            bg_img_url: 'https://i.ibb.co/GfmvvPN/2021-06-19-165207.png',
            top_bar: {
        ...
        return (
            <React.Fragment>
                <div onContextMenu={() => this.rotateAndroid()} className={this.state.rotate ? "android-phone rotate-androind" : "android-phone"}>
                    <img className="phone__box" src={`https://gta-5.ru/server/client/images/icons/components/phone/img/iphone_frame.png`} alt="" />
