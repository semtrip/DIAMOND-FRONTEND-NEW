                    ...
                    <div className="left-topbar">
                        {this.props.data.wifi ?
                            <div className="elements-bar">
                                <img src={`https://gta-5.ru/server/client/images/icons/components/phone/img/Wi-Fi.svg`} width="12" className="elements-bar__icon" />
                            </div>
                            : null}
                        <div className="elements-bar">
                        ...
                        <div className="elements-bar">
                            <img src={`https://gta-5.ru/server/client/images/icons/components/phone/img/battery.svg`} width="17.5" className="elements-bar__icon" />
