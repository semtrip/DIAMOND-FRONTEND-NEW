...
class PhoneBook extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            search: '',
            pagesList: [
                {icon: `https://gta-5.ru/server/client/images/icons/components/phone/img/Favorites.svg`, name: 'Избранное', page: 'favorit'},
                {icon: `https://gta-5.ru/server/client/images/icons/components/phone/img/Recents.svg`, name: 'Журнал', page: 'history'},
